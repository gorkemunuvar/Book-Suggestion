<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Kitaplar.aspx.cs" Inherits="_Default" %>
    ...
    <form id="form1" runat="server">
        <div class="ana_div" id="iskelet">
            <div class="div1" id="div1">
                <asp:Menu ID="Menu1" runat="server" BackColor="#F7F6F3" DynamicHorizontalOffset="2" Font-Names="Verdana" Font-Size="0.8em" ForeColor="#7C6F57" StaticSubMenuIndent="10px" Height="163px" Width="85px">
                    ...
                    <Items>
                        ...
                        <asp:MenuItem Text="Kitaplar" Value="Kitaplar" NavigateUrl="~/Kitaplar.aspx" Selected="True">
                            <asp:MenuItem NavigateUrl="~/PopulerKitaplar.aspx" Text="PopülerKitaplar" Value="PopülerKitaplar"></asp:MenuItem>
                            <asp:MenuItem NavigateUrl="~/YuksekPuanliKitaplar.aspx" Text="Yüksek Puanlı Kitaplar" Value="Yüksek Puanlı Kitaplar"></asp:MenuItem>
                        </asp:MenuItem>
            ...
            <div class="div" id="div2">
                <hr />
                <center>
                    <asp:Label ID="Label1" runat="server" Text="Kitaplar"></asp:Label>
               </center>
                <hr />
            </div>
            <div class="div" id="div3">
                <table border="0 " cellpadding="0">
                    ...
                    <tr>
                        <asp:GridView ID="gVKitaplar" runat="server" CellPadding="4" ForeColor="Black" GridLines="Vertical" OnInit="gVKitaplar_Init" OnSelectedIndexChanged="gVKitaplar_SelectedIndexChanged" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" AutoGenerateSelectButton="True">
