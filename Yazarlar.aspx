<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Yazarlar.aspx.cs" Inherits="_Default" %>
    ...
    <form id="form1" runat="server">
        <div class="ana_div" id="iskelet">
            <div class="div1" id="div1">
                <asp:Menu ID="Menu1" runat="server" BackColor="#F7F6F3" DynamicHorizontalOffset="2" Font-Names="Verdana" Font-Size="0.8em" ForeColor="#7C6F57" StaticSubMenuIndent="10px" Height="163px" Width="85px">
                    ...
                    <Items>
                        ...
                        <asp:MenuItem Text="Yazarlar" Value="Yazarlar" NavigateUrl="~/Yazarlar.aspx" Selected="True">
                            <asp:MenuItem NavigateUrl="~/PopulerYazarlar.aspx" Text="Popüler Yazarlar" Value="Popüler Yazarlar"></asp:MenuItem>
                        </asp:MenuItem>
            ...
            <div class="div" id="div2">
                <hr />
                <center>
                    <asp:Label ID="Label1" runat="server" Text="Yazarlar"></asp:Label>
               </center>
                <hr />
            </div>
