<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Tavsiyeler.aspx.cs" Inherits="_Default" %>
        ...
        <div class="ana_div" id="iskelet">
            <div class="div1" id="div1">
                <asp:Menu ID="Menu1" runat="server" BackColor="#F7F6F3" DynamicHorizontalOffset="2" Font-Names="Verdana" Font-Size="0.8em" ForeColor="#7C6F57" StaticSubMenuIndent="10px" Height="163px" Width="85px">
                    ...
                    <Items>
                        <asp:MenuItem Text="Tavsiyeler" Value="Tavsiyeler" NavigateUrl="~/Tavsiyeler.aspx" Selected="True"></asp:MenuItem>
            ...
            <div class="div" id="div2">
                <hr />
                <center>
                    <asp:Label ID="Label1" runat="server" Text="Tavsiye Edilen Kitaplar"></asp:Label>
               </center>
                <hr />
            </div>
            <div class="div" id="div3">
                <table border="0 " cellpadding="0">
                    <tr>
                        <td>
                            <hr />
                            <asp:Label ID="lblSonuc" runat="server">Size önerilen 10 kitap!</asp:Label>
                    ...
                    <tr>
                        <td colspan="2">
                            <asp:GridView ID="gVOnerilenKitaplar" runat="server" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" OnInit="gVOnerilenKitaplar_Init">
