<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PopulerKitaplar.aspx.cs" Inherits="_Default" %>
    ...
    <form id="form1" runat="server">
        <div class="ana_div" id="iskelet">
            ...
            <div class="div" id="div2">
                <hr />
                <center>
                    <asp:Label ID="Label1" runat="server" Text="Popüler Kitaplar"></asp:Label>
               </center>
                <hr />
            </div>
